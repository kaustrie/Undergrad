...
/* This class is used to record the declared types of functions and their parameters in 
      ...
      HashMap<String,TypeVal> funTypeTable 
      HashMap<String,HashMap<String,TypeVal>> paramTypeTable
      HashMap<String,HashMap<Integer,TypeVal>> paramNumTypeTable

   which are included in the class "ParserTypeChecker.java".
